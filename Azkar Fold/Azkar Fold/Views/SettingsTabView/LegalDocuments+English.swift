...
extension LegalDocuments {
    static func englishLastUpdated() -> String {
        String(localized: "legal.last_updated_date", bundle: LocalizationBundle.bundle(for: "en"))
    }

    static var englishPrivacyPolicySections: [LegalDocumentSection] {
        [
    ...
    static var englishTermsOfServiceSections: [LegalDocumentSection] {
        [
            LegalDocumentSection(
                title: "Agreement",
                body: """
